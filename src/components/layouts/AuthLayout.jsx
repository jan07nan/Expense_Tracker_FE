  ...
  return (
    <div className="flex">
      ...
      <div className="hidden md:block w-[40vw] h-screen bg-violet-50 bg-auth-bg-img bg-cover bg-no-repeat bg-center overflow-hidden p-8 relative">
        ...
        <div className="w-48 h-56 rounded-[40px] border-[20px] border-lime-600 absolute top-[30%] -right-10" />
        ...
        <img
          src={loginImg}
          className="w-64 lg:w-[90%] absolute rounded-2xl bottom-10 shadow-lg shadow-blue-400/15"
        />
      </div>
    </div>
  );
